//empty array to append to it later, lower case letter, uppercase letter, numbers from 0-9 and special characters in the form of array.
...
function generatePassword() {
  ...
  while (
    ...
    alert(
      "Please choose a number that is more than 8 and less than 128 characters"
    );
